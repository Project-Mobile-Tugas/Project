        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              padding: EdgeInsets.fromLTRB(32*fem, 33*fem, 32*fem, 214*fem),
              width: double.infinity,
              child: Column(
                ...
                children: [
                  Container(
                    // headermenuwzn (7:563)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 38*fem, 51*fem),
                    width: 288*fem,
                    height: 41*fem,
                    child: Stack(
                      children: [
                  ...
                  Container(
                    // orderboxXrW (7:580)
                    margin: EdgeInsets.fromLTRB(41*fem, 0*fem, 38*fem, 16*fem),
                    padding: EdgeInsets.fromLTRB(27*fem, 25*fem, 40*fem, 34*fem),
                    width: double.infinity,
                    decoration: BoxDecoration (
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          // menuqty2YN (7:571)
                          margin: EdgeInsets.fromLTRB(10*fem, 0*fem, 0*fem, 23*fem),
                          child: Text(
                            'Menu                  qty',
                            textAlign: TextAlign.center,
                            style: SafeGoogleFont (
                        ...
                        Container(
                          ...
                          margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 14*fem, 156*fem),
                          width: double.infinity,
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(71*fem, 0*fem, 81*fem, 0*fem),
                    width: double.infinity,
                    height: 29*fem,
                    decoration: BoxDecoration (
                      borderRadius: BorderRadius.circular(10*fem),
